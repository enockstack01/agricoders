    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-1 bg-gray-100 p-1 rounded-xl">
        ...
        >
          ...
          Products
          {products.length > 0 && (
            <span className="text-xs bg-green-100 text-green-700 rounded-full px-1.5 py-0.5 font-semibold">{products.length}</span>
          )}
        </button>
        <button
          type="button"
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="bg-gray-50">
                            <th className="px-3 py-2 text-left text-xs font-semibold text-gray-500">Component / Material</th>
                            <th className="px-3 py-2 text-right text-xs font-semibold text-gray-500 w-20">Qty</th>
                            <th className="px-3 py-2 text-right text-xs font-semibold text-gray-500 w-32">Cost/Unit ({cur})</th>
                        ...
                        <tbody>
                          ...
                          <tr className="bg-green-50 font-semibold text-sm">
                            <td colSpan={3} className="px-3 py-2 text-right text-gray-600">Batch Total</td>
